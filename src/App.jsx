    ...
    <main className=" min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center  items-center">
      <section className="lg:flex max-w-[920px]">
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <h2 className="font-sholders mb-7 uppercase text-4xl font-bold text-offwhitebg">Sedans</h2>
          <p className="font-lexend mb-7 text-offwhite lg:mb-20">Escolha um sedan pelo seu preço acessivel e excelente economia de combustivel. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
        ...
        <div className="bg-green p-12">
          ...
          <h2 className="font-sholders mb-7 uppercase text-4xl font-bold text-offwhitebg">SUVs</h2>
        ...
        <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg">
          ...
          <h2 className="font-sholders mb-7 uppercase text-4xl font-bold text-offwhitebg">Luxuosos</h2>
          ...
          <a className="font-lexend bg-offwhitebg px-10 py-3 w-fit rounded-3xl text-dark-green border-2 hover:bg-dark-green hover:text-offwhitebg" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
